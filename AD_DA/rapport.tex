...
Le principe de la chambre d'écho est d'échantillonner un signal audio à l'aide du convertisseur AN, de stocker les échantillons dans un tampon circulaire réalisé à l'aide d'une mémoire 8-bits, puis de restituer les données passées qui sont stockées dans la mémoire à l'aide du convertisseur NA.\\
\includegraphics{principe_chambre_d'echo.png}

Il y a alors plusieurs modes de fonctionnement :
\begin{itemize}
\item \textbf{Retard pur} : Le  est désactivé mais l'écho est activé. Il s'agit donc d'un simple retard.
...
\includegraphics[width = 1\linewidth]{shema_sequenceur_2.png}
...
\includegraphics{chronogramme_sequenceur.png}
...
\includegraphics[width = 7 cm]{err_quantification_8bit_t.png} & \includegraphics[width = 7 cm]{err_quantification_8bit_f.png}
\\
Erreur de quantification 8-bits sur une période de sinus & Spectre de l'erreur de quantification
\\
\includegraphics[width = 7 cm]{err_quantification_4bit_t.png} & \includegraphics[width = 7 cm]{err_quantification_4bit_f.png}
\\
Erreur de quantification 4-bits sur une période de sinus & Spectre de l'erreur de quantification
\\
\includegraphics[width = 7 cm]{err_quantification_1bit_t.png} & \includegraphics[width = 7 cm]{err_quantification_1bit_f.png}
\\
Erreur de quantification 1-bit sur une période de sinus & Spectre de l'erreur de quantification
\end{tabular}
