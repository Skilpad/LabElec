...
\\\\
Les deux bascules D de U19 forment un compteur Johnson de longueur 2, qui a 4 états. D'après la datasheet du composant 74HC74 le changement d'état se fait au flanc montant de CLK :
\\
\begin{center}
\begin{tabular}{|c|c|c|c|c|c|}
\hline
\multicolumn{2}{|c|}{Etat} & CK & /CK & R/W & INC \\
\hline
0 & 0 & 0 & 1 & 1 & 0 \\
%\hline
0 & 1 & 0 & 1 & 1 & 1 \\
...
Il y a donc un "cycle" pour chaque période de CK, soit 4 périodes de CLK. Chaque cycle se décompose donc en 4 phases bien distinctes :
\begin{itemize}
\item \textbf{00 -} Lecture de l'ancienne valeur par le convertisseur N/A (flanc descendant de CK)
\item \textbf{01 -} Pas d'opération
\item \textbf{11 -} Ecriture de la nouvelle valeur dans la SRAM (état bas de R/W)
\item \textbf{10 -} Mise à jour du bus d'adresses (flanc descendant de INC)
\end{itemize}
\includegraphics{shema_memoire.png}
...
Par contre lorsque qu'il reste très peu de bits, par exemple le cas extrême où on n'a qu'un seul bit, le signal échantillonné devient :
