...
%TODO: Comment se comportent les LEDs au changement dans les 4 MSBs ? Les MSBs et LSBs changent-ils en même temps ?
...
%TODO: Pourquoi cet effet de la parité de i ???
...
Afin d'observer l'effet de la quantification, sans être perturbé par l'échantillonnage, on utilise en entrée un signal lent~: $f_{in}\ll f_{ech}$ (où $f_{ech}$ désigne la fréquence d'échantillonnage des convertisseurs, que l'on sait de l'ordre de $20\mathrm{kHz}$). Typiquement, on utilisera ici $f_{in} = ?$ %TODO: valeur pour f_in=0,5Hz
