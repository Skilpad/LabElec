...
En effet, le quartz agit comme un filtre précis en fréquence, et son facteur de qualité Q est très largement plus élevé que celui d'un filtre à composant LC (qui présentent des imperfections).\\

Le quartz peut être modélisé de la façon suivante :\footnote{Source : $http://www.acedim.com/Formatronic/Electro_2/oscillateur/lequartz.html$}
\begin{center}
...
Il est nécessaire que le résonateur $L_{41}$ et $C_{42}$ soit accordé à une fréquence très proche de celle du quartz, sinon le guain de la boucle complète (amplification par le transistor, filtrage LC et filtrage avec le quartz) aura un guain inférieur à 1, et il ne pourra pas y avoir d'oscillations.
...
On fait une analyse en courant continu, c'est à dire que toutes les inductances sont des court-circuits, et les capacités ainsi que le quartz sont circuits ouverts.\\
Le courant de polarisation Ic de $1mA$ doit circuler dans le collecteur et l'émetteur du transistor. On désire avoir 1V sur l'émetteur, d'où la valeur de $R_{42}$ :
\begin{center}
...
La sortie, qui se trouve sur le collecteur du transistor, à une composante continue de +7V car elle est reliée à l'alimentation par une inductance. La composante alternative peut descendre au plus jusqu'à $Ub$ = 1.7V sans subir de déformations. Il est donc possible d'avoir jusqu'à 5.3V d'amplitude crête en sortie.\\
...
Réglage de P41 : On constate que, lorsqu'on monte le curseur, c'est à dire lorsqu'on augmente le courrant sur la sortie, la fréquence augmente. Cela revient à diminuer le facteur de qualité du résonateur de sortie. Apparemment notre quartz à une fréquence propre un peu plus élevée que 9MHz mais le réglage à été établi de manière à ajuster la fréquence. Le fait de diminuer le facteur de qualité diminue l'influence du réglage sur la fréquence, d'où un rapprochement à la fréquence propre du quartz c'est à dire une augmentation.
