...
%TODO (Paul) J'ai refais les calculs : il n'y aurait pas de perte lié au sommateur --- en supposant qu'il utilise 3 résistances de 50ohm en triangle (ce qui, de mémoire, est le cas). En effet, on montre que relier 2 générateurs ayant chacun une résistance série 50ohm et un générateur de tension E1/E2 parfait à un triangle de résistances 50ohm mène au générateur équivalent suivant : un générateur de tension parfaite égale à la tension moyenne (E1+E2)/2 en série avec une résistance 50ohm

On cherche tout d'abord à déterminer le taux de distorsion d'inter-modulation d'ordre trois.
En se plaçant à 10 dB en dessous du maximum pour notre signal d'entrée, on obtient le spectre Fig.~\ref{fig:9_3_4}.
